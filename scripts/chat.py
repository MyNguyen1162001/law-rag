"""Use case 3 — Chatbot. Hybrid retrieve + Gemini answer with citations."""
...
from law_rag import config, retriever, store
...
def _format_context(ids_scores) -> str:
    ...
    data = coll.get(ids=[cid for cid, _ in ids_scores])
